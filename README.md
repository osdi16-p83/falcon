...
After May 10th, we conducted more **scalability evaluations** and you may check it  [here](https://docs.google.com/spreadsheets/d/1rHpv_gA_SS8XpS4sq5aLFjr_ztEPhTUH-r-1fR1_u60/edit?usp=sharing). For all the evaluated applications, when cluster size varies from 3 to 17 nodes, the consensus latency increase 45% at most and 16% at least.
